export function createPixelReveal(opts) {
    const { canvas, imageSrc, blockSize: BLOCK_SIZE = 8, pixelsPerFrame: PIXELS_PER_FRAME = 120, glitchRegion = 0.36, delay = 200, onComplete, } = opts;
